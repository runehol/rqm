...
namespace rqm
{
    ...
    {
        znum c(znum::empty_with_n_digits(), add_digit_estimate(a.get_n_digits(), b.get_n_digits()));
    ...
    znum operator*(const znum &a, const znum &b)
    {
        znum c(znum::empty_with_n_digits(), multiply_digit_estimate(a.get_n_digits(), b.get_n_digits()));
    ...
    znum operator*(const znum &a, int32_t b)
    {
        ...
        znum c(znum::empty_with_n_digits(), multiply_digit_estimate(a.get_n_digits(), 1));
    ...
    {
        znum c(znum::empty_with_n_digits(), shift_left_digit_estimate(a.get_n_digits(), b));
    ...
    znum operator>>(const znum &a, uint32_t b)
    {
        znum c(znum::empty_with_n_digits(), shift_right_digit_estimate(a.get_n_digits(), b));
    ...
    {
        znum c(znum::empty_with_n_digits(), gcd_digit_estimate(a.get_n_digits(), b.get_n_digits()));
